...
build_files=$(ls build/*.{js,asset.php})

# Generate the plugin zip file.
status "Creating archive... 🤐"

zip -r ./dist/post-reading-time-block.zip \
	block.json \
        post-reading-time-block.php \
        license.txt \
	$build_files \
	readme.txt

# Reset `post-reading-time-block.php`.
git checkout post-reading-time-block.php

# Unzip plugin zip file
unzip ./dist/post-reading-time-block.zip -d "./dist/post-reading-time-block/"
